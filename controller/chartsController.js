...
*/
    ...
    const totalBottleConsumption = bottleConsumption.length > 0 ? bottleConsumption[0].totalConsumption : 0;
    const totalWaterProviderConsumption = waterProviderConsumption.length > 0 ? waterProviderConsumption[0].totalConsumption : 0;

    console.log(totalWaterProviderConsumption, "totalNonRenewableConsumption", totalBottleConsumption, "totalProviderEnergyConsumption");
    const totalWaterConsumption = totalBottleConsumption + totalWaterProviderConsumption

    // Log and return the result
    // console.log(result, "result");
    const bottlePercentage = totalBottleConsumption > 0 ? (totalBottleConsumption / totalWaterConsumption) * 100 : 0;
    const waterPercentage = totalWaterProviderConsumption > 0 ? (totalWaterProviderConsumption / totalWaterConsumption) * 100 : 0;
